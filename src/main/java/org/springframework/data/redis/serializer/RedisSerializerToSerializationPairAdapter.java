 ...
 * <p>
 * 一个适配器，这里面会使用一种代理、委托的思想，将序列化/反序列化的任务交给 RedisSerializer，毕竟 RedisSerializer 已经设计好了
 *
 * @author Mark Paluch
